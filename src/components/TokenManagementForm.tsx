...
function TokenManagementForm({ name, inputs }: Props) {
            ...
            {/* <div className="flex justify-center items-center h-screen w-full"> */}
                <div className="w-1/2 bg-white rounded shadow-2xl p-8 m-4"> 
                    ...
                    <form action="/" method="post">
                        ...
                        <button className="block bg-teal-400 hover:bg-teal-600 text-white uppercase text-lg mx-auto p-4 rounded" type="submit">Write</button>
                    </form>
                 </div>
            {/* </div> */}
        </>

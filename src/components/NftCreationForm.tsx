        ...
        <div className="flex flex-wrap justify-center items-center w-full">
            <div className="w-full bg-gray-200 rounded shadow-2xl p-8 m-4"> 
                ...
                <div className="flex flex-col mb-4">
                    ...
                    <input className="border py-2 px-3 text-sm text-black" placeholder="Select Image" type="image" />
                </div>
                <Button label="Create NFT" className="block bg-gray-400 hover:bg-gray-600 text-white uppercase text-sm mx-auto p-4 rounded" />
            </div>
        </div>
    );
}
